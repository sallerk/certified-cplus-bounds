...
`C_+(28) <= 1.1079`. Every number below is under it. The headline `1.0951788`
sits `4.8%` of the way across the remaining bracket `[1.0942036, 1.1079]`.
...
proven upper bound (UPPER.md)           1.1079
